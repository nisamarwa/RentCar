        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="phone_number" class="form-control" placeholder="Nomor Telepon" required="">
                </div>
                <div class="form-group">
                    <label>Nomor SIM</label>
                    <input type="text" name="sim_number" pattern="^\d{16}$" class="form-control" placeholder="Nomor SIM" required="" title="Nomor SIM harus terdiri dari 16 digit angka">
                </div>
                <div class="form-group">
